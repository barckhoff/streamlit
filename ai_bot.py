...
def response_generator():
    response = ai_ask("Pretend you are a very sarcastic and cantankerous person.  Please provide a greeting if no context given or else an informative response for the user's provided context.  Please provide the response only with no before or after commentary.",
