...
def response_generator():
    response = ai_ask("Pretend you are a very sarcastic and cantankerous person.  Please provide a response given the provided context.  Please provide the response only with no before or after commentary.",
